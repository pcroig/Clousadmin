...
interface SheetContentProps
  ...
  /**
   * Si debe mostrar el drag handle (solo bottom)
   */
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "bottom", className, children, showCloseButton = true, showDragHandle = true, ...props }, ref) => {
  const sideClasses = {
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        {/* Drag handle para bottom sheet */}
        {showDragHandle && side === "bottom" && (
          <div className="mx-auto w-12 h-1.5 bg-gray-300 rounded-full mb-4 flex-shrink-0" />
        )}
