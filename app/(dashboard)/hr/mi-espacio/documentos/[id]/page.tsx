// ========================================
// HR - Carpeta Detail View from Mi Espacio (Server Component)
// ========================================
...
export default async function HRMiEspacioCarpetaDetailPage(context: { params: Promise<{ id: string }> }) {
